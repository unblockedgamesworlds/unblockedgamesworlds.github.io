...
function playGame(){
  document.querySelector(".game-frame").innerHTML = `<iframe src="${document.querySelector('#talpa-splash-button').dataset.url}" id="gameframe" frameborder="0" style="height: 575px; width: 1028px;"></iframe>`;
}
