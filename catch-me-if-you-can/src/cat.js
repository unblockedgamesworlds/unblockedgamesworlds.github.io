!function (t) {
    ...
    var k = function (t) {
        ...
        return r(e, t), Object.defineProperty(e.prototype, "blocks", {
            ...
            get: function () {
                ...
                switch (t) {
                    case i.PLAYING:
                        break;
                    case i.LOSE:
                        this.setStatusText(f.default("The cat has run to the edge of the map, you lose"));
                        break;
                    case i.WIN:
                        this.setStatusText(f.default("The cat has nowhere to go, you win"));
                        break;
                    default:
                        return
                }
            ...
            return n ? n.isWall ? (this.setStatusText(f.default("The click position is already a wall, so click is prohibited")), !1) : this.cat.i === t && this.cat.j === e ? (this.setStatusText(
                f.default("The clicked position is the current position of the cat, click is prohibited")), !1) : (n.isWall = !0, this.cat.isCaught() ? (this.setStatusText(f.default("The cat has nowhere to go, you win")), this.state = i.WIN, !1) : (this.setStatusText(f.default("you clicked ") + "(" + t + ", " + e + ")"), this.cat.step() || (this.setStatusText(f.default("Cat admit defeat, you win!")), this.state = i.WIN), !0)) : (this.setStatusText(f.default("Error, current location does not exist")), !1)
        }, e.prototype.reset = function () {
            this.cat.reset(), this.resetBlocks(), this.randomWall(), this.state = i.PLAYING, this.setStatusText(f.default("Click on the dots to surround the kitten"))
