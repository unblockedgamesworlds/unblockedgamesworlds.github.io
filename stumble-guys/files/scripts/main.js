...
'use strict'; {
    const DISPATCH_WORKER_SCRIPT_NAME = "/files/scripts/dispatchworker.js";
    const JOB_WORKER_SCRIPT_NAME = "files/scripts/jobworker.js";
...
'use strict'; {
    if (window["C3_IsSupported"]) {
        ...
        window["c3_runtimeInterface"] = new self.RuntimeInterface({
            ...
            engineScripts: ["/files/scripts/c3runtime.js"],
            projectScripts: [],
            mainProjectScript: "",
            scriptsType: "module",
